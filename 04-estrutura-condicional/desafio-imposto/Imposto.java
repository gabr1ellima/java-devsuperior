...
public class Imposto {
	...
	public static void main(String[] args) {
		...
		double rendaAnualSalario, rendaAnualServ, rendaAnualCap, gastosMed, gastosEdu, salario, impostoSal, impostoServ,
				impostoCap;
		...
		if (salario < 3000.0) {
			...
			double impostoDevido = (maxDedutiveis > gastosDedutiveis) ? impostoBruto - gastosDedutiveis
					: impostoBruto - maxDedutiveis;
